...
# TODO Сделать что если приоритет 2 отправлялось сообщение о том что по 2 кругу; Сделать приоритетные дежурства; Отправка Полине на проверку
# TODO Можно: Дата последнего дежурства, Удаление сообщений
